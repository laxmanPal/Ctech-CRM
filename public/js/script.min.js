...
!(function (e) {
  ...
  e(".table-responsive--dynamic .dropdown").on("show.bs.dropdown", function () {
    ...
    e("#datepicker7").datepicker({ minDate: -20, maxDate: "+1M +10D" }),
  ...
  p.classList.add("overlay-dark"),
    ...
    e(
      "#countryOption,#cityOption,#skillsOption,#exampleFormControlSelect1,exampleFormControlSelect2,#select-countryOption"
    ).select2({
